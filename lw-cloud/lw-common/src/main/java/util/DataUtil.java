...
public final class DataUtil {
	...
	public static final String arrayToString(Object[] array, String separator) {
		...
		if (separator == null) {
			separator = Constant.COMMA_SEPARATOR;
		}
	 ...
	 * @return
	 */
	public static final String findByRegx(String str, String regx) {
	 ...
	 * @return
	 */
	public static final String null2Zero(String str) {
		if (str == null) {
			return "0";
		}
		return str;
	 ...
	 * @return
	 */
	public static final Double nullToZero(Double str) {
		if (str == null) {
